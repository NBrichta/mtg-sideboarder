...
with tab4:  # Play/Draw
    ...
    st.markdown(
        "For now, SideBoarder doesn't have explicit support for defining matchups on the play versus on the draw. This is a heavily requested feature, as your play patterns against certain decks may depend on who goes first. While we work on implementing this, the quick fix is to treat either scenario as a new matchup. Using the sample decklist, this would look like:"
    )
